...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <CaretSortIcon className="select-trigger__icon" />
  ...
  <SelectPrimitive.Portal>
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          "select-content__viewport p-1",
          position === "popper" && "select-content__viewport__popper",
        )}
      >
        {children}
      </SelectPrimitive.Viewport>
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    {...props}
  >
    <span className="select-item__span">
